...
const PageTransition = ({ children }) => <div className="animate-fadeIn">{children}</div>

function App() {
  return (
    <ThemeProvider>
      <div className="app-wrapper min-h-screen bg-secondary-50 dark:bg-secondary-900 text-secondary-900 dark:text-white">
        <CustomCursor />
        <Router>
          <Routes>
            {/* Public Routes */}
