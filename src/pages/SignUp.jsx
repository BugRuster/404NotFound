...
const SignUp = () => {
  ...
  const documentationQuotes = [
    "Join us in shaping the future of documentation...",
    "Your journey to better documentation starts here...",
    "Unlock the power of collaborative documentation...",
    "Create, share, and evolve your documentation...",
    "Building the next generation of documentation tools...",
  ];
          ...
          <div className={`w-full max-w-md space-y-8 transform transition-all duration-1000 ${
            ...
            <div>
              ...
              <h2 className="mt-6 text-3xl font-bold tracking-tight text-white text-center font-mono">
                Initialize Account<span className="animate-pulse">_</span>
              </h2>
            </div>
              ...
              <div className="space-y-4">
                <div className="group">
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/40 group-focus-within:text-white/70 transition-colors duration-300" />
                    <input
                      type="text"
                      name="name"
                      required
